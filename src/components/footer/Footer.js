...
const navigation = {
    ...
    social: [
      {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/in/daniel-bednarz/',
        icon: (props) => (
      ...
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/danielwalkerdev/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
      ...
      {
        name: 'Twitter',
        href: 'https://twitter.com/danielwalkerdev',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/danielbednarz2',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
    ...
    return (
      <footer id="footer" className="bg-white">
        <div className="mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400">&copy; 2023 Daniel Walker Dev. All rights reserved.</p>
        </div>
      </footer>
    )
  }