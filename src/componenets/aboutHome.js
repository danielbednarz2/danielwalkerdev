...
const AboutHome = () => (
    <Wrapper id="about">
      <About>
        ...
        <Tech>
            <ul>
                <a href="https://discoverboldly.com/articles/8" target="blank" rel="noreferrer">
                    <li><Html5 className="myHtml"/></li>
                </a>
                <a href="https://discoverboldly.com/articles/10" target="blank" rel="noreferrer">
                    <li><ReactJs className="myReact" /></li>
                </a>
                <a href="https://discoverboldly.com/articles/12" target="blank" rel="noreferrer">
            ...
            <ul>
                ...
                <a href="https://discoverboldly.com/articles/11" target="blank" rel="noreferrer">
                    <li><NodeDotJs className="myNode"/></li>
                </a>
                <a href="https://discoverboldly.com/articles/13" target="blank" rel="noreferrer">
                    <li><Postgresql className="myPostgres"/> </li>
                </a>
            </ul>
            <ul>
                <a href="https://discoverboldly.com/articles/9" target="blank" rel="noreferrer">
                ...
                <a href="https://discoverboldly.com/articles/14" target="_blank" rel="noreferrer">
